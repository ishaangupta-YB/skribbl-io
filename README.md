...
Phase 0 (Foundation & Contract) is complete: monorepo tooling, the frozen `@skribbl/shared` contract, and the mock server. See `TODO.md` for live progress and `PLAN.md` for the full roadmap.
